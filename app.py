...
# Calculate Sun-Mars Planetary Momentum Angle
...
def fetch_market_data(target_date):
    ...
    start_gann = end_date - timedelta(days=3650) # 10 Years for Gann Stats
...
with st.spinner(f"Synchronizing with NSE Servers & Ephemeris DB for {selected_date}..."):
    idx_daily, idx_intraday, stock_intraday, stock_swing, stock_gann = fetch_market_data(selected_date)
...
<div class="explainer-box">
    <b>📖 How to use this:</b> Check this table during market hours (9:15 AM - 3:30 PM). It looks for extreme 15-minute oversold/overbought conditions. <br>
    <b>🟢 BUY CE (Call):</b> Market crashed too fast and is bouncing. Buy the exact CE option listed. Target is +0.25% Index move. <br>
    <b>🔴 BUY PE (Put):</b> Market pumped too fast and is rejecting. Buy the exact PE option listed.
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="explainer-box">
    <b>📖 How to use this:</b> Same as Index options, but for individual Stocks. Hold time is approx 90 minutes. <br>
    <b>🔥 BUY CE:</b> Astro score is highly bullish, and 15M RSI just hit extreme oversold. Buy the exact Strike listed. Target is 0.5% underlying move.<br>
    <b>🩸 BUY PE:</b> Astro score is hostile, and the stock pumped too fast into upper resistance.
</div>
""", unsafe_allow_html=True)
